...
class UserFull {
    ...
    getMaxIncrease() {
        ...
        if (maxIncreaseAccValue > 0.3) this.achievement.addAchieve(maxIncreaseAccEnd, "这天您的acc提升了" + maxIncreaseAccValue.toFixed(2) + "%！");
        if (maxDecreaseAccValue < -0.3) this.achievement.addAchieve(maxDecreaseAccEnd, "这天您的acc降低了" + (-maxDecreaseAccValue).toFixed(2) + "%...");
    }
